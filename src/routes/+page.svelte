<script lang="ts">
	...
	const list2 = newList(
		'bist2',
		writable([
			{ uid: crypto.randomUUID(), name: '1' },
			{ uid: crypto.randomUUID(), name: '2' },
			{ uid: crypto.randomUUID(), name: '3' },
			{ uid: crypto.randomUUID(), name: '4' },
			{ uid: crypto.randomUUID(), name: '5' },
			{ uid: crypto.randomUUID(), name: '6' },
			{ uid: crypto.randomUUID(), name: '7' },
			{ uid: crypto.randomUUID(), name: '8' },
			{ uid: crypto.randomUUID(), name: '9' },
